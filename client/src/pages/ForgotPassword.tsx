    ...
    <div style={{
      ...
      <div style={{ width: '100%', maxWidth: 380 }}>
        <div style={{ textAlign: 'center', marginBottom: 32 }}>
          ...
          <h1 style={{ fontSize: 24, fontWeight: 800, letterSpacing: '-.3px', margin: 0, color: '#1D1D1F' }}>Reset Password</h1>
          <p style={{ fontSize: 14, color: '#86868B', margin: '4px 0 0' }}>{sent ? 'Check your email' : 'Enter your email to receive a reset link'}</p>
        </div>
        ...
        {sent ? (
          <div style={{ textAlign: 'center', background: 'rgba(255,255,255,.72)', borderRadius: 20, padding: 28, boxShadow: '0 1px 3px rgba(0,0,0,.04)' }}>
            ...
            <p style={{ fontSize: 14, color: '#1D1D1F', marginBottom: 16 }}>If an account exists for {email}, a reset link has been sent.</p>
            <Link to="/login" style={{ color: '#007AFF', fontWeight: 600, textDecoration: 'none', fontSize: 14 }}>Back to Sign In</Link>
          </div>
        ) : (
          <form onSubmit={handleSubmit} style={{ background: 'rgba(255,255,255,.72)', backdropFilter: 'blur(24px)', borderRadius: 20, padding: 28, boxShadow: '0 1px 3px rgba(0,0,0,.04), 0 4px 20px rgba(0,0,0,.06)' }}>
            ...
            <div style={{ marginBottom: 20 }}>
              <label style={{ display: 'block', fontSize: 12, fontWeight: 600, color: '#86868B', marginBottom: 6 }}>Email</label>
              <input type="email" value={email} onChange={e => setEmail(e.target.value)} placeholder="hello@studiosage.com" autoFocus
            ...
            <p style={{ textAlign: 'center', marginTop: 20, fontSize: 13, color: '#86868B' }}>
              <Link to="/login" style={{ color: '#007AFF', fontWeight: 600, textDecoration: 'none' }}>Back to Sign In</Link>
            </p>
          </form>
        )}
      </div>
